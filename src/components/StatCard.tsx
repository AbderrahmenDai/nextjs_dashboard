...
const colorMap = {
    blue: "from-blue-500 to-cyan-400 shadow-blue-500/10",
    purple: "from-purple-500 to-pink-400 shadow-purple-500/10",
    orange: "from-orange-500 to-yellow-400 shadow-orange-500/10",
    green: "from-green-500 to-emerald-400 shadow-green-500/10",
};
...
export function StatCard({ title, value, change, trend, icon: Icon, color }: StatCardProps) {
    return (
        <div className="bg-card dark:glass-card border border-border/50 p-6 rounded-2xl relative overflow-hidden group shadow-lg shadow-gray-200/50 dark:shadow-none transition-all duration-300 hover:shadow-xl hover:translate-y-[-2px]">
            <div className="flex justify-between items-start mb-4">
                ...
                <div className={clsx(
                    ...
                    trend === "up" ? "bg-green-500/10 text-green-600 dark:text-green-400" :
                        trend === "down" ? "bg-red-500/10 text-red-600 dark:text-red-400" : "bg-secondary text-muted-foreground"
                )}>
            ...
            <div>
                <h3 className="text-muted-foreground font-medium text-sm mb-1 uppercase tracking-wide">{title}</h3>
